				...
				<div className="grid grid-cols-1 md:grid-cols-2  container mx-auto mt-8">
					...
					<div className="p-4 md:order-first text-lg ">
						...
						<p className="py-2 leading-relaxed font-normal">
							I've been an avid reader and tech enthusiast since my
							childhood. My coding journey began when I discovered
							HTML while trying to design an <em>car gallery website</em> as a school project. 
							I've developed many projects after I
							discovered JavaScript and PostgreSQL back in early 2017. 
							<br/> For the past few years, I've been learning <i>TypeScript,
							React, TailwindCSS</i> and trying to keep up with
							industry standards.
						</p>
						<p className="py-2 leading-relaxed font-normal">
							I enjoy learning both fundamental computer science
							and new technologies. Recently, I have been interested in<br/><i>Deep Learning for Computer Vision</i>.
						</p>
						<div className="mt-4">
							<Link
